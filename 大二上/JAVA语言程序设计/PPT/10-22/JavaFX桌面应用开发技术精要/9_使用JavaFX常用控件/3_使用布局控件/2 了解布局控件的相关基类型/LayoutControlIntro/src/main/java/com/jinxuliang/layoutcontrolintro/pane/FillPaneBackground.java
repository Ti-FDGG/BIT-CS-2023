...
public class FillPaneBackground extends Application {
	...
	public void start(Stage stage) {
		...
		p2.layoutXProperty().bind(p1.layoutXProperty()
				.add(p1.widthProperty()).add(20));

		Pane root = new Pane(p1, p2);
		root.setPrefSize(280, 70);
		Scene scene = new Scene(root);
		stage.setScene(scene);
		stage.setTitle("设置pane的背景");
		stage.show();
		stage.sizeToScene();
	}
